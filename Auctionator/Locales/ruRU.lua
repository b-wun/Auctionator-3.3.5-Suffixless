...
AtrL["You may have at most 40 single-stack (x1)\nauctions posted for this item.\n\nYou already have %d such auctions and\nyou are trying to post %d more."] = "Вы можете иметь не более 40 однорядные (x1) аукционов относительно этого пункта. У вас уже есть %d таких аукционов, а вы пытаетесь разместить %d больше."
